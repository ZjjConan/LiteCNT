function [bboxes, speed, searchArea, template, feature, response] = tracker_gt(varargin)
    ...
    if ischar(p.net)
        ...
        net_path = fullfile(p.paths.net_base, p.net);
...
%             p.targetSize =  p.ground_truth(i, [4,3]);
%         end
