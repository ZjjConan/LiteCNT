function [net, state] = base_finetune(net, trainFeatrs, trainLabels, state, varargin)
...
%         if opts.startFrame   
            ...
            lindex = perm(t);
%         else
%             lindex = 1:size(trainFeatrs, 4);
%             findex = 1:size(trainFeatrs, 4);
%         end
