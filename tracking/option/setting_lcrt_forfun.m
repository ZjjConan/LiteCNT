function opts = setting_lcrt_forfun(opts, levels)
    ...
    opts = lcrt_get_opts('verbose', opts.verbose, 'useGpu', opts.useGpu, ...
                         ...
                         'searchPadding', 3.5, 'warmupTimes', 10, ...
                         ...
                         'updateLr', 1e-5, 'outputSigmaFactor', 1/12, ...
                         'numMultiLevels', levels);

    opts.state_initialize = @lcrtv3_state_initialize;
    opts.state_warmup = @lcrtv3_warmup;
    opts.initialize = @lcrtv3_initialize;
    opts.track = @lcrtv3_track;
